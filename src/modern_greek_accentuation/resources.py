...
prefixes_before_augment = {'ανα': 'αν', 'απο': 'απ', 'επι': 'επ', 'διακατ': 'διακατ', 'αν': 'αν', 'δια': 'δι',
                           'δι': 'δι', 'εκ': 'εξ',
                           'συλ': 'συν', 'εμπερι': 'εμπερι', 'επανεξ': 'επανεξ', 'επανεκ': 'επανεξ',
                           'παραεισ': 'παραεισ',
                           'απο': 'απ', 'κακο': 'κακο', 'καλο': 'καλο', 'αντικατα': 'αντικατ', 'συναπο': 'συναπ',
                           'επανεισ': 'επανεισ',
                           'απ': 'απ', 'ισαπ': 'ισαπ', 'προ': 'προ', 'κατα': 'κατ', 'κατ': 'κατ', 'παρα': 'παρα',
                           ' παρα': 'παρ',
                           ...
                           'ξαπο': 'ξαπ', 'διεμ': 'διεν',
                           'αποδια': 'αποδι', 'ανταπο': 'ανταπ', 'συνεφ': 'συνεφ', 'παρεισ': 'παρεισ',
                           'επαναπο': 'επαναπ',
