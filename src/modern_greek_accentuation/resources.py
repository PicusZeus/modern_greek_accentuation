...
dict_of_augmented_prefixes = {'ανα': 'ανε', 'δια': 'διε', 'εκ': 'εξε', 'συν': 'συνε', 'απο': 'απε', 'προ': 'προε',
                              ...
                              'περι': 'περιε', 'υπα': 'υπη', 'εν': 'ενε', 'υπο': 'υπε', 'αμφι': 'αμφε',
                              'επιπαρα ': 'παρεεπε', 'κατα':'κατε', 'εισ': 'εισε', 'αντι': 'αντε', 'παρεμ': 'περενε',
                              'επι': 'επε', 'μετα': 'μετε', 'προσ': 'προσε', 'ανα ': 'ανη', 'συνα': 'συνη', 'απα': 'απη',
                              'περια': 'περιη', 'ενα': 'ενη', 'κατα ': 'κατη', 'εισα': 'ειση', 'επα': 'επη', 'μετα ': 'μετη',
                              'προσα': 'προση'
                              }
